...
import com.example.weathertest.data.db.LocalDateConverter
import com.example.weathertest.data.internal.DateNotFoundException
...
class FutureDetailFragment : ScopedFragment(), KodeinAware {
    ...
    private val viewModelFactoryInstanceFactory: ((LocalDate) -> FutureDetailViewModelFactory) by factory()
...
//
//        val safeArgs = arguments?.let { FutureDetailFragmentArgs.fromBundel(it) }
//        val date = LocalDateConverter.stringToDate(safeArgs?.dateString) ?: throw DateNotFoundException()
//        viewModel = ViewModelProvider(this, viewModelFactoryInstanceFactory(date)).get(FutureDetailViewModel::class.java)
//
//        bindUI()
//
//    }
